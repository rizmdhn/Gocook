...
public class ChickenRecyclerviewadapter extends RecyclerView.Adapter<ChickenRecyclerviewadapter.ViewHolder> {

    Context context;
    ArrayList<MenuREPO> list;
    LinearLayout linearLayout;

    public ChickenRecyclerviewadapter(Context context, ArrayList<MenuREPO> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.tripImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.startActivity(new Intent(context, RoastChic.class));
            }
        });
